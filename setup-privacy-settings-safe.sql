-- =====================================================
-- Safe Setup Script for Privacy Settings
-- =====================================================
...
CREATE TABLE IF NOT EXISTS user_privacy_settings (
  ...
  connection_request_filter VARCHAR(20) DEFAULT 'everyone',
  allow_group_invitations BOOLEAN DEFAULT true,
  
  -- Location & Activity
  share_location VARCHAR(20) DEFAULT 'connections_only',
  show_activity_status BOOLEAN DEFAULT true,
  
  -- Communication Controls
  allow_direct_messages BOOLEAN DEFAULT true,
  direct_message_filter VARCHAR(20) DEFAULT 'connections',
...
-- Create the privacy_settings_history table (if it doesn't exist)
...
DROP POLICY IF EXISTS "Users can view their own privacy history" ON privacy_settings_history;
DROP POLICY IF EXISTS "System can insert privacy history" ON privacy_settings_history;
